  ...
  <el-input v-model="searchInfo.type" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column align="left" label="图片URL" prop="imageUrl" width="120" />

            <el-table-column align="left" label="链接URL" prop="linkUrl" width="120" />

            <el-table-column sortable align="left" label="排序" prop="order" width="120" />

            <el-table-column align="left" label="状态" prop="status" width="120" />

            <el-table-column align="left" label="轮播图位置" prop="type" width="120" />
    ...
    {{ detailFrom.imageUrl }}
                    ...
                    <el-descriptions-item label="链接URL">
    {{ detailFrom.linkUrl }}
</el-descriptions-item>
    ...
    {{ detailFrom.status }}
                    ...
                    <el-descriptions-item label="轮播图位置">
    {{ detailFrom.type }}
</el-descriptions-item>
            </el-descriptions>
        </el-drawer>

  ...
  <el-input class="w-40" v-model.number="searchInfo.endPrice" placeholder="最大值" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column align="left" label="课程名称" prop="courseTitle" width="120" />

            <el-table-column align="left" label="讲师" prop="teacher" width="120">
    <template #default="scope">
        <span>{{ filterDataSource(dataSource.teacher,scope.row.teacher) }}</span>
    </template>
</el-table-column>
    ...
    <template #default="scope">{{ formatBoolean(scope.row.onSale) }}</template>
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateCourseFunc(scope.row)">编辑</el-button>
    ...
    <el-image style="width: 50px; height: 50px" :preview-src-list="returnArrImg(detailFrom.coverImage)" :src="getUrl(detailFrom.coverImage)" fit="cover" />
</el-descriptions-item>

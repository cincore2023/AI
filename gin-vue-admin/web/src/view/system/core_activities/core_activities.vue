  ...
  <el-select v-model="searchInfo.status" clearable placeholder="请选择">
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column align="left" label="活动名称" prop="activityName" width="120" />

            <el-table-column sortable align="left" label="活动价格" prop="price" width="120" />
    ...
    <template #default="scope">
        <span>{{ filterDataSource(dataSource.category,scope.row.category) }}</span>
            ...
            <el-table-column align="left" label="封面图" prop="coverPicture" width="120" />

            <el-table-column align="left" label="展示报名人数" prop="actualEnrollment" width="120" />
   ...
   <template #default="scope">{{ formatDate(scope.row.endTime) }}</template>
            ...
            <el-table-column align="left" label="展示开始时间" prop="showStartTime" width="180">
   <template #default="scope">{{ formatDate(scope.row.showStartTime) }}</template>
</el-table-column>
            <el-table-column align="left" label="展示结束时间" prop="showEndTime" width="180">
   <template #default="scope">{{ formatDate(scope.row.showEndTime) }}</template>
</el-table-column>
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            <template #default="scope">
            <el-button  type="primary" link class="table-button" @click="getDetails(scope.row)"><el-icon style="margin-right: 5px"><InfoFilled /></el-icon>查看</el-button>
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateActivitiesFunc(scope.row)">编辑</el-button>
    ...
    {{ detailFrom.showStartTime }}
</el-descriptions-item>
                    <el-descriptions-item label="展示结束时间">
    {{ detailFrom.showEndTime }}
</el-descriptions-item>
            </el-descriptions>
        </el-drawer>

  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column align="left" label="名称" prop="levelName" width="120" />

            <el-table-column align="left" label="会员提成" prop="memberCommission" width="120" />

            <el-table-column align="left" label="活动提成" prop="activityCommission" width="120" />

            <el-table-column align="left" label="数字人提成" prop="digitalPersonCommission" width="120" />

        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            <template #default="scope">
            <el-button  type="primary" link class="table-button" @click="getDetails(scope.row)"><el-icon style="margin-right: 5px"><InfoFilled /></el-icon>查看</el-button>
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateBenefitFunc(scope.row)">编辑</el-button>
    ...
    {{ detailFrom.levelName }}
                    ...
                    <el-descriptions-item label="会员提成">
    {{ detailFrom.memberCommission }}
</el-descriptions-item>
                    <el-descriptions-item label="活动提成">
    {{ detailFrom.activityCommission }}
</el-descriptions-item>
                    <el-descriptions-item label="数字人提成">
    {{ detailFrom.digitalPersonCommission }}
</el-descriptions-item>
            </el-descriptions>
        </el-drawer>
...
const getTableData = async() => {
  const table = await getBenefitList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
// 更新行
const updateBenefitFunc = async(row) => {
    const res = await findBenefit({ ID: row.ID })
    type.value = 'update'
    if (res.code === 0) {
...
// 删除行
const deleteBenefitFunc = async (row) => {
    const res = await deleteBenefit({ ID: row.ID })
    if (res.code === 0) {
        ElMessage({
                type: 'success',
                message: '删除成功'

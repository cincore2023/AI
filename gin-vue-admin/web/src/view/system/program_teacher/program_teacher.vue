  ...
  <el-input v-model.number="searchInfo.sort" placeholder="搜索条件" />
    ...
    <template #default="scope">
      <el-image preview-teleported style="width: 100px; height: 100px" :src="getUrl(scope.row.avatar)" fit="cover"/>
            ...
            <el-table-column align="left" label="讲师姓名" prop="name" width="120" />

            <el-table-column align="left" label="讲师描述" prop="description" width="120" />

            <el-table-column label="讲师介绍" prop="introduction" width="200">
   <template #default="scope">
      [富文本内容]
   </template>
</el-table-column>
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateTeacherFunc(scope.row)">编辑</el-button>

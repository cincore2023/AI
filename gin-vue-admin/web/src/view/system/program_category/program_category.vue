...
<template>
  <div>
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt" min-width="180">
    ...
    <template #default="scope">{{ formatBoolean(scope.row.status) }}</template>
            ...
            <el-table-column align="left" label="分类类型" prop="type" width="120" />

        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            <template #default="scope">
            <el-button  type="primary" link class="table-button" @click="openDialog(scope.row)"><el-icon style="margin-right: 5px"><InfoFilled /></el-icon>新增子节点</el-button>
            ...
            <el-button v-if="!scope.row.children?.length"   type="primary" link icon="delete" @click="deleteRow(scope.row)">删除</el-button>
            </template>
        </el-table-column>
        </el-table>
